...
const PreSurvey = ({ nextProgress }) => {
  ...
  const questions = [
    {
      ...
      options: [
        ...
        { value: 'monthly', label: 'At least once a month' },
    ...
    },
    {
      ...
      options: [
        ...
        { value: 'almostNever', label: 'Almost never' },
      ],
    },
    {
      name: 'AIReliability',
      ...
      options: [
        { value: 'almostAlwaysUnreliable', label: 'Almost always unreliable' },
        { value: 'oftenUnreliable', label: 'Often unreliable' },
        { value: 'sometimesReliableSometimesUnreliable', label: 'Sometimes reliable, sometimes unreliable' },
  ...
  const microeconomicsQuestion = {
      ...
      options: [
        { value: 'apOrCollege', label: 'I have taken either AP Microeconomics or a college Microeconomics course.' },
        { value: 'nonCollege', label: 'I have taken a non-college-level Microeconomics class.' },
